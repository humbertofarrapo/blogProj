...
const User = ({ item }) => {
  ...
  const sendFollow = async (currentUserId, selectedUserId) => {
    try {
      const response = await fetch("https://37c993c6-7d90-4eb5-bf6d-42564beec53b-00-l4ltwecn8s44.kirk.replit.dev/follow", {
        method: "POST",
        headers: {
  ...
  const handleUnfollow = async (targetId) => {
    try {
      const response = await fetch("https://37c993c6-7d90-4eb5-bf6d-42564beec53b-00-l4ltwecn8s44.kirk.replit.dev/users/unfollow", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
